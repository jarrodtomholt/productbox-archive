...
<div class="space-y-1 mt-6" role="group" aria-labelledby="projects-headline">
  <a v-for="" href="#" class="group flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50">
    <span class="truncate">
      Website redesign
    </span>
  </a>
